  ...
  <div v-if="visible">
    ...
    <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2" :class="editMode ? '' : 'del-log-preview'">
      ...
      <div v-for="d in items" :key="d.path" class="border rounded p-1 bg-red-50 relative">
        ...
        <img v-if="d.thumb_url" :src="d.thumb_url" loading="lazy" class="lb-thumb w-full aspect-square object-cover rounded bg-gray-100 cursor-pointer" :data-path="d.path" :data-del-thumb="d.thumb_url" data-mtime="" data-ip="" />
